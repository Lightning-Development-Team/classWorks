...
function defineCustomElement(element, elementName) {
    return new Promise(resolve => {
        ...
        xhr.onload = req => {
            ...
            const beforeCreateScript = template.querySelector("script[beforeCreate]")?.innerHTML
            const mountedScript = template.querySelector("script[mounted]")?.innerHTML
            console.log(mountedScript);
